...
{/* TopAppBar */}
<header className="fixed top-0 right-0 z-40 flex justify-between items-center w-full px-8 h-20 ml-64 glass-effect border-none">
...
<input className="bg-surface-container-low border-none rounded-full pl-12 pr-6 py-2.5 w-80 text-sm focus:ring-2 focus:ring-primary/10 transition-all" placeholder="Search assets, news..." type="text"/>
</div>
</div>
<div className="flex items-center gap-4">
<button className="p-2.5 rounded-full hover:bg-surface-container-high transition-colors">
...
<div className="h-10 w-10 rounded-full overflow-hidden ml-2 ring-2 ring-primary/5">
<img alt="User profile avatar" data-alt="professional portrait of a financial advisor in a suit with warm studio lighting" src="https://lh3.googleusercontent.com/aida-public/AB6AXuC6Srm9o49-SpOb8GkDfMDzaqwCvwbOjD3C0l5T_871g_SLkIkpWcRWAHkFLGVnfhQdn9ZzxuwL0QbwGMsZpFDHZXDxfA-i217Q1du9VEV9uMgQwj8kmZPQMw3_I264owgt2tYgxUUOiiHdzn8WqDdUpUcTrPvDU1ueHIMF3jFdU8mLo4v8MDymZipPkyMCn_QqN_mDqL1RhZSQ6BksaV7ABNB8ufiT8YcuBATpNOQjZTADxHhYUKdozAb7eyoY5Ta1_o47WWEB1K2i"/>
</div>
</div>
</header>
...
<button className="px-6 py-2 rounded-full text-sm font-medium text-on-surface-variant hover:text-primary transition-colors">1D</button>
<button className="px-6 py-2 rounded-full text-sm font-medium text-on-surface-variant hover:text-primary transition-colors">1W</button>
<button className="px-6 py-2 rounded-full bg-surface-container-lowest shadow-sm text-sm font-bold text-primary">1M</button>
<button className="px-6 py-2 rounded-full text-sm font-medium text-on-surface-variant hover:text-primary transition-colors">1Y</button>
<button className="px-6 py-2 rounded-full text-sm font-medium text-on-surface-variant hover:text-primary transition-colors">ALL</button>
</div>
</div>
...
<button className="px-6 py-2 rounded-lg text-sm font-bold bg-surface-container-lowest shadow-sm">Stocks</button>
<button className="px-6 py-2 rounded-lg text-sm font-medium text-on-surface-variant hover:text-primary transition-colors">Crypto</button>
<button className="px-6 py-2 rounded-lg text-sm font-medium text-on-surface-variant hover:text-primary transition-colors">Real Estate</button>
</div>
</div>
...
<button className="px-4 py-2 bg-primary text-on-primary rounded-lg text-xs font-bold">Buy</button>
<button className="px-4 py-2 border border-outline/20 text-primary rounded-lg text-xs font-bold hover:bg-surface">Sell</button>
</div>
</div>
{/* Asset Row 2 */}
<div className="group flex items-center justify-between p-4 bg-surface-container-lowest rounded-2xl hover:bg-surface-container-high transition-all cursor-pointer">
...
<button className="w-full mt-6 py-4 text-sm font-bold text-primary-container hover:underline transition-all">View all 12 assets</button>
</div>
{/* Market News Feed */}
<div>
...
<span className="material-symbols-outlined text-primary cursor-pointer hover:scale-110 transition-transform" data-icon="bookmark">bookmark</span>
</div>
</div>
<div className="bg-surface-container-lowest rounded-3xl p-6 shadow-sm border border-outline/5">
...
<button className="w-full mt-6 py-3 border border-on-primary-container/20 rounded-xl text-xs font-bold hover:bg-on-primary-container/5 transition-all">Edit Watchlist</button>
</div>
</div>
<div className="bg-surface-container-low rounded-3xl p-8">
