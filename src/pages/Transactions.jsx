        ...
        <div className="flex flex-col gap-6 pb-16 animate-in fade-in duration-500">
            ...
            <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1 text-sm">Manage and view your transaction history.</p>
                </div>
                {role === 'admin' && (
                    <button
            ...
            <div className="flex flex-col sm:flex-row gap-3">
                ...
                <div className="flex items-center gap-2 bg-card border border-border rounded-lg px-3 shadow-sm">
                    ...
                    <select
                        ...
                        className="bg-transparent border-none text-foreground text-sm focus:outline-none cursor-pointer py-2.5 min-w-[130px]"
                    >
