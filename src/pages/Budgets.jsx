    ...
    <div className="animate-in fade-in duration-500">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-primary-container p-8 rounded-xl text-white flex flex-col justify-between">
          ...
          <button onClick={() => toast.success('Recommendation Engine initialized', { icon: '🤖' })} className="bg-white/10 hover:bg-white/20 transition-colors py-3 rounded-lg border border-white/10 text-sm font-bold flex items-center justify-center gap-2">
      ...
      <section>
        <div className="flex justify-between items-center mb-6">
          ...
          <button onClick={() => toast('New Savings Goal wizard opened', { icon: '🎯' })} className="flex items-center gap-2 px-6 py-2 rounded-full border border-outline-variant hover:bg-surface-container-high transition-colors text-sm font-bold">
      ...
      <section className="bg-surface-container-low rounded-xl overflow-hidden">
        <div className="p-8 border-b border-outline-variant/10 flex justify-between items-center">
          ...
          <button onClick={() => toast('Budget Limit Editor opened', { icon: '✏️' })} className="bg-primary text-white px-6 py-2 rounded-full font-bold text-sm hover:opacity-90">
            Edit All Limits
          </button>
        </div>
        <div className="p-8 space-y-6">
          ...
          <div className="flex items-center justify-between group">
            ...
            <div className="flex items-center gap-8 w-48 justify-end">
              ...
              <span onClick={() => toast('Category budget editor opened')} className="material-symbols-outlined text-on-surface-variant cursor-pointer hover:text-primary" data-icon="edit">edit</span>
            </div>
          </div>
          {/* Category 2 */}
          <div className="flex items-center justify-between group">
